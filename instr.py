...
txt_hello = 'Добро пожаловать в приложение по определению состояния здоровья!   '
txt_next = 'Начать'
...
txt_res1 = 'НИЗКАЯ! СРОЧНО К ВРАЧУ!'
txt_res2 = 'Удволетворительная, обратитесь к врачу'
